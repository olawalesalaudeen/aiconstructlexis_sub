...
A multimodal sentiment analysis benchmark for post-level sentiment classification on image-text posts.

## Sources

**[An Empirical Study on Configuring In-Context Learning Demonstrations for Unleashing MLLMs’ Sentimental Perception Capability](https://raw.githubusercontent.com/mlresearch/v267/main/assets/wu25ao/wu25ao.pdf)**
> A multimodal sentiment analysis benchmark for post-level sentiment classification on image-text posts.

## Relationships

### → MVSA-M
- **Emotion understanding** (constructs) — *measured_by*
